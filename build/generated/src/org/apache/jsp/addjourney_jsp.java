...
//            Route route = routeDao.findOne(Route.class, Long.parseLong(request.getParameter("id")));
      ...
      out.write("                <h3 class=\"block text-base text-center font-medium text-gray-700\"> Update Route</h3>\n");
      out.write("                <div class=\"flex flex-col items-center shadow overflow-hidden sm:rounded-md\">\n");
      out.write("                    <div class=\"px-4 py-5 flex sm:p-6 gap-4 w-1/2\">\n");
      out.write("                            <div class=\"\">\n");
      out.write("                                <label for=\"id\" class=\"block text-sm font-medium text-gray-700\">id</label>\n");
      out.write("                                <input type=\"number\" name=\"id\" id=\"id\" readonly=\"true\" value=\"\" autocomplete=\"given-name\" class=\"mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md\">\n");
      out.write("                            </div>\n");
      out.write("\n");
      out.write("                            <div class=\"\">\n");
      out.write("                                <label for=\"source\" class=\"block text-sm font-medium text-gray-700\">source</label>\n");
      out.write("                                <input type=\"text\" name=\"source\" id=\"source\" value=\"\" class=\"mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md\">\n");
      out.write("                            </div>\n");
      out.write("                            \n");
      out.write("                            <div class=\"\">\n");
      out.write("                                <label for=\"destination\" class=\"block text-sm font-medium text-gray-700\">destination</label>\n");
      out.write("                                <input type=\"text\" name=\"destination\" id=\"destination\" value=\"\" class=\"mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md\">\n");
      out.write("                            </div>\n");
      out.write("                        \n");
      out.write("                    </div>\n");
      out.write("                    <input type=\"text\" name=\"action\" hidden=\"\" value=\"updateroute\">\n");
