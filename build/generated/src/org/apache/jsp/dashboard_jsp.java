...
//            List<Company> companylist = companyDao.findAll(new Company());
      ...
      out.write("                                <label for=\"first_name\" class=\"block text-sm font-medium text-gray-700\">First name</label>\n");
      out.write("                                <input type=\"text\" name=\"first_name\" id=\"first_name\" autocomplete=\"given-name\" class=\"mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md\">\n");
      out.write("                            </div>\n");
      out.write("\n");
      out.write("                            <div class=\"col-span-6 sm:col-span-3\">\n");
      out.write("                                <label for=\"last_name\" class=\"block text-sm font-medium text-gray-700\">Last name</label>\n");
      out.write("                                <input type=\"text\" name=\"last_name\" id=\"last_name\" autocomplete=\"family-name\" class=\"mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md\">\n");
      out.write("                            </div>\n");
      out.write("                        </div>\n");
      out.write("                    </div>\n");
      ...
      out.write("                        <td class=\"py-3 px-6 text-left whitespace-nowrap font-medium\">#1</td>\n");
      out.write("                        <td class=\"py-3 px-6 text-left text-blue-600 whitespace-nowrap font-medium\">KIGALI</td>\n");
      out.write("                        <td class=\"py-3 px-6 text-left text-purple-600 whitespace-nowrap font-medium\">HUYE</td>\n");
