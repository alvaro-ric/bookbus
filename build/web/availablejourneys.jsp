...
<html class="no-js" lang="zxx">
    ...
    <body>
        ...
        <main class="container" style="height: 50vh;">
            ...
            <div class="flex w-2/3 max-w-sm max-h-56 mx-auto overflow-hidden bg-white rounded-lg shadow-md dark:bg-gray-800">
                ...
                <div class="px-4 py-2 -mx-3">
                    <div class="mx-3">
                        ...
                        <p class="text-base text-gray-800 dark:text-gray-200"><%=message%></p>
            ...
            <%} else {
                List<Journey> journeys = (List<Journey>) session.getAttribute("journeys");
            %>
            <div class="row">
                <div class="col-lg-12" style="text-align: center;">
                    <h3 class="mb-30">Journey Available</h3>
                </div>
            </div>
                    ...
                    <tr class="border-b border-gray-200 hover:bg-gray-100">
                        ...
                        <td>
                            <div class="flex item-center justify-center">
                                ...
                                <a href="JourneyControl?id=<%=journey.getId()%>&action=proceed" class="focus:outline-none text-blue-600 text-sm py-1.5 px-4 rounded-md border border-blue-600 hover:bg-blue-600 hover:text-white flex items-center">
                                    <svg class="w-4 h-4 mr-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 8h10M7 12h4m1 8l-4-4H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-3l-4 4z" />
                                    </svg>
                                    Buy
