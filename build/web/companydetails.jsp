<%-- 
    ...
    Created on : Apr 14, 2021, 9:04:01 AM
    Author     : Philip
--%>
...
<%@page import="model.CompanyState"%>
...
<html lang="en">
    ...
    <body class="h-screen overflow-hidden flex items-center justify-start" style="background: #edf2f7">
        ...
        <%
            ...
            List<CompanyState> companyStateList = companyDao.getCompanyStates(id);
            //            request.setAttribute("genderlist", ds.getGenderList());
        ...
        <div class="overflow-x-auto bg-white w-5/6 h-screen mt-0 md:mt-0 md:col-span-2">
            ...
            <table class="min-w-max w-full table-auto">
                ...
                <tbody class="text-gray-600 text-sm font-light">
                    <%
                        for (CompanyState companyState : companyStateList) {
                           
                    %>
                    <tr class="border-b border-gray-200 hover:bg-gray-100">
                        <td class="py-3 px-6 text-left whitespace-nowrap font-medium"><%=companyState.getCompany().getName()%></td>
                        <td>
                            <%
                                if (companyState.getCompanyStatus().toString().equals("CREATED")) {
                            %>
                            <span class="mx-auto bg-yellow-200 text-yellow-800 py-1 px-3 rounded-full text-xs"><%=companyState.getCompanyStatus()%></span>
                            <%} else if (companyState.getCompanyStatus().toString().equals("APPROVED")) {%>
                            <span class="mx-auto bg-green-200 text-green-800 py-1 px-3 rounded-full text-xs"><%=companyState.getCompanyStatus()%></span>
                            <%} else {%>
                            <span class="mx-auto bg-red-200 text-red-800 py-1 px-3 rounded-full text-xs"><%=companyState.getCompanyStatus()%></span>
                            <%}%>
                        </td>
                        <td class="py-3 px-6 text-left whitespace-nowrap font-medium"><%=companyState.getUpdateOn()%></td>
                        <td class="py-3 px-6 text-left whitespace-nowrap font-medium"><%=companyState.getDoneBy().getEmail()%></td>
