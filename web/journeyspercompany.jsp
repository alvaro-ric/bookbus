<%-- 
    Document   : journeyspercompany
    Created on : Apr 23, 2021, 9:58:10 AM
    Author     : Philip
--%>

<%@page import="dao.JourneyDao"%>
<%@page import="model.Journey"%>
<%-- 
    Document   : routespercompany
    Created on : Apr 22, 2021, 11:54:48 AM
    Author     : Philip
--%>
...
<html lang="en">
    ...
    <body class="h-screen overflow-hidden flex items-center justify-start" style="background: #edf2f7">
        ...
        <div class="overflow-x-auto bg-white w-5/6 h-screen mt-0 md:mt-0 md:col-span-2">
            ...
            <h3 class="block text-base text-center font-medium text-gray-700 py-3"> All Journeys</h3>
            <table class="min-w-max w-full table-auto">
                <thead>
                    <tr class="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                        ...
                        <th class="py-3 px-6 text-left">Scheduled on</th>
                        <th class="py-3 px-6 text-left">plateNo</th>
                        <th class="py-3 px-6 text-left">price</th>
                        <th class="py-3 px-6 text-left">Seats</th>
                        <th class="py-3 px-6 text-left">Taken</th>
                ...
                <tbody class="text-gray-600 text-sm font-light">
                    ...
                    <tr class="border-b border-gray-200 hover:bg-gray-100">
                        <td class="py-3 px-6 text-left whitespace-nowrap font-medium"><%=journey.getRoute().getSource()%></td>
                        <td class="py-3 px-6 text-left whitespace-nowrap font-medium"><%=journey.getRoute().getDestination()%></td>
                        <td class="py-3 px-6 text-left whitespace-nowrap font-medium"><%=journey.getCreatedAt()%></td>
                        <td class="py-3 px-6 text-left whitespace-nowrap font-medium"><%=journey.getDepartureDate()%> <%=journey.getDepartureTime()%></td>
                        <td class="py-3 px-6 text-left whitespace-nowrap font-medium"><%=journey.getPlateNo()%></td>
                        <td class="py-3 px-6 text-left whitespace-nowrap font-medium"><%=journey.getPrice()%></td>
                        <td class="py-3 px-6 text-left whitespace-nowrap font-medium"><%=journey.getSeats()%></td>
                        <td class="py-3 px-6 text-left whitespace-nowrap font-medium"><%=journey.getTaken()%></td>
                        <td>
                            <%
                                if (journey.getJourneyStatus().toString().equals("BOOKING")) {
                            %>
                            <span class="mx-auto bg-green-200 text-green-800 py-1 px-3 rounded-full text-xs"><%=journey.getJourneyStatus()%></span>
                            <%} else {%>
                            <span class="mx-auto bg-red-200 text-red-800 py-1 px-3 rounded-full text-xs"><%=journey.getJourneyStatus()%></span>
                            <%}%>
                        </td>
                    </tr>
                    <%}%>
