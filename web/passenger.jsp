<%-- 
    Document   : passenger
    Created on : May 1, 2021, 7:13:19 PM
    Author     : Philip
--%>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-lg-12" style="text-align: center;">
                            <h3 class="mb-30">Passenger Details</h3>
                        </div>
                        <div class="col-lg-6">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <form action="PassengerControl" method="POST">
                                ...
                                <input type="text" name="action" hidden="" value="addpassenger">
                                <div class="mt-10">
                                    <button type="submit" class="genric-btn warning">Submit</button>
                                </div>
