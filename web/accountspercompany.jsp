<%-- 
    Document   : accountspercompany
    Created on : Apr 30, 2021, 8:29:43 PM
    Author     : Philip
--%>
...
<html lang="en">
    ...
    <body class="h-screen overflow-hidden flex items-center justify-start" style="background: #edf2f7">
        <%
            ...
            List<ManagerAccount> accountList = null;
            if (session.getAttribute("user") == null) {
                ...
                try {
                    ...
                    accountList = accountDao.getCompanyAccounts(account.getCompany().getId());
                } catch (ClassCastException e) {
                    response.sendRedirect("login.jsp?trigger=accountpercompany");
                }
        ...
        <div class="overflow-x-auto bg-white w-5/6 h-screen mt-0 md:mt-0 md:col-span-2">
            ...
            <%}%>
            <h3 class="block text-base text-center font-medium text-gray-700 py-3"> All Accounts</h3>
            <table class="min-w-max w-full table-auto">
                ...
                <tbody class="text-gray-600 text-sm font-light">
                    <%
                        for (ManagerAccount account : accountList) {

                    %>
                    <tr class="border-b border-gray-200 hover:bg-gray-100">
                        <td class="py-3 px-6 text-left whitespace-nowrap font-medium"><%=account.getManager().getFirstName()%></td>
                        <td class="py-3 px-6 text-left whitespace-nowrap font-medium"><%=account.getManager().getLastName()%></td>
                        <td class="py-3 px-6 text-left whitespace-nowrap font-medium"><%=account.getManager().getPhoneNumber()%></td>
                        <td class="py-3 px-6 text-left whitespace-nowrap font-medium"><%=account.getEmail()%></td>

                        <td>
                            <%
                                if (account.getAccountStatus().toString().equals("CREATED")) {
                            %>
                            <span class="mx-auto bg-yellow-200 text-yellow-800 py-1 px-3 rounded-full text-xs"><%=account.getAccountStatus()%></span>
                            <%} else if (account.getAccountStatus().toString().equals("APPROVED")) {%>
                            <span class="mx-auto bg-green-200 text-green-800 py-1 px-3 rounded-full text-xs"><%=account.getAccountStatus()%></span>
                            <%} else {%>
                            <span class="mx-auto bg-red-200 text-red-800 py-1 px-3 rounded-full text-xs"><%=account.getAccountStatus()%></span>
                            <%}%>
                        </td>
                        <!--                        <td class="py-3 px-6 text-center">
                                                    <div class="flex item-center justify-center">
                                                        <a href="accountdetails.jsp?id=<%=account.getId()%>">
                                                        ...
                                                        <a href="updateaccount.jsp?id=<%=account.getId()%>">
                                                            <div class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <td class="py-3 px-6 text-center">
                            <div class="flex item-center justify-center">
                                <a href="accountstates.jsp?id=<%=account.getId()%>" class="mr-4 focus:outline-none text-blue-600 text-sm py-1.5 px-4 rounded-md border border-blue-600 hover:bg-blue-600 hover:text-white flex items-center">
                                ...
                                <%
                                    if (account.getAccountStatus().equals("CREATED")) {
                                %>
                                <a href="AccountControl?id=<%=account.getId()%>&action=approve" class="focus:outline-none text-green-600 text-sm py-1.5 px-4 rounded-md border border-green-600 hover:bg-green-600 hover:text-white flex items-center">
                                    <svg class="w-4 h-4 mr-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <%} else if (account.getAccountStatus().toString().equals("APPROVED")) {%>
                                <a href="AccountControl?id=<%=account.getId()%>&action=suspend" class="focus:outline-none text-red-600 text-sm py-1.5 px-4 rounded-md border border-red-600 hover:bg-red-600 hover:text-white flex items-center">
                                    <svg class="w-4 h-4 mr-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
