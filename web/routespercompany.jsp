    ...
    <body class="h-screen overflow-hidden flex items-center justify-start" style="background: #edf2f7">
        <%
            ...
            if (session.getAttribute("user") == null) {
                ...
                routelist = routeDao.getCompanyRoutes(account.getCompany().getId());
            }
            ...
            <div class="flex flex-col sm:flex-row sm:justify-around">
                <div class="w-64 h-screen bg-gray-800">
                    ...
                    <div class="absolute bottom-0 my-8">
                        <a
                            class="flex items-center py-2 px-8 text-gray-300 mx-1 rounded-full bg-gray-600 hover:text-gray-200"
                            href="#"
                            >
            ...
            <table class="min-w-max w-full table-auto">
                <thead>
                    <tr class="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                        ...
                        <th class="py-3 px-6 text-left">Registered Date</th>
                ...
                <tbody class="text-gray-600 text-sm font-light">
                    ...
                    <tr class="border-b border-gray-200 hover:bg-gray-100">
                        <td class="py-3 px-6 text-left whitespace-nowrap font-medium"><%=route.getRoute().getSource()%></td>
                        <td class="py-3 px-6 text-left text-blue-600 whitespace-nowrap font-medium"><%=route.getRoute().getDestination()%></td>
                        <td class="py-3 px-6 text-left text-purple-600 whitespace-nowrap font-medium"><%=route.getRegisteredDate()%></td>
                        <td>
                            <%
                                if (route.getRouteStatus().toString().equals("REQUESTED")) {
                            %>
                            <span class="mx-auto bg-yellow-200 text-yellow-800 py-1 px-3 rounded-full text-xs"><%=route.getRouteStatus()%></span>
                            <%} else if(route.getRouteStatus().toString().equals("APPROVED")) {%>
                            <span class="mx-auto bg-green-200 text-green-800 py-1 px-3 rounded-full text-xs"><%=route.getRouteStatus()%></span>
                            <%} else {%>
                            <span class="mx-auto bg-red-200 text-red-800 py-1 px-3 rounded-full text-xs"><%=route.getRouteStatus()%></span>
                            <%}%>
                        </td>
                    </tr>
                    <%}%>
