                    ...
                    <div class="single-slider hero-overly slider-height2 d-flex align-items-center" data-background="assets/img/hero/h1_hero.jpg">
                        <div class="container">
                            ...
                            <div class="row">
                                <div class="col-xl-12">
                                    <!-- form -->
                                    <form action="JourneyControl" class="search-box">
                                        ...
                                        <div class="inline-block mr-2 mt-2">
                                            <button type="submit" class="focus:outline-none text-white text-sm py-2.5 px-5 rounded-md bg-yellow-500 hover:bg-yellow-600 hover:shadow-lg">Search</button>
                                        </div>
